...
public class IconTextListAdapter extends ArrayAdapter<IconTextItem> implements OnClickListener{
	...
	public IconTextListAdapter(Context context, Intent fromLogIn, int textViewResourceId, ArrayList<IconTextItem> items) {
...
//			intent.setClass(context, CertainActivity.class);
			break;
...
//			intent.setClass(context, InfoActivity.class);
		...
		Bundle extras = fromLogIn.getExtras();
